...
const projects = [
...

  {
    ...
    about:
      "Das Bauvorhaben „Am Franzenbrunnen“ umfasst die Planung eines modernen Mehrfamilienhauses mit zwei Wohneinheiten in einem neu erschlossenen Wohngebiet in Saarbrücken. Der Entwurf zeichnet sich durch eine klare, zeitlose Architektursprache sowie funktional durchdachte Grundrisse aus. Ziel ist die Schaffung von hochwertigem Wohnraum mit hoher Aufenthaltsqualität und optimaler Nutzung der vorhandenen Flächen. Unser Büro war in diesem Projekt für die Leistungsphasen 1–4 verantwortlich – von der Grundlagenermittlung über die Entwurfs- und Genehmigungsplanung bis hin zur Bauantragstellung. Ergänzend dazu wurden sämtliche Visualisierungen für Innen- und Außenbereiche erstellt, um das Projekt bereits in der Planungsphase realitätsnah darzustellen. Besonderes Augenmerk lag auf der harmonischen Fassadengestaltung, einer modernen Materialwahl sowie der Integration großzügiger Fensterflächen zur Schaffung heller und offener Wohnräume. Der Baubeginn ist für Juli 2026 vorgesehen, die geplante Bauzeit beträgt etwa zwei Jahre.",
  },
  ...
  about:
    "Das Bauvorhaben „Rathausplatz 29–33“ in Völklingen umfasst die Entwicklung eines modernen, innerstädtischen Quartiers mit gemischter Nutzung aus Wohnen, Gewerbe und sozialen Wohnformen. Im Fokus der Planung steht die Schaffung eines lebendigen und funktionalen Stadtquartiers mit hochwertiger Architektur, klarer Strukturierung und einer nachhaltigen Nutzungsmischung. Das Projekt kombiniert moderne Wohnformen mit gewerblichen Flächen und schafft dadurch ein urbanes Umfeld mit hoher Aufenthaltsqualität.Im Erdgeschoss entstehen mehrere Gewerbeeinheiten sowie flexible Co-Working-Flächen, die das Quartier funktional ergänzen und zur Belebung des öffentlichen Raums beitragen. In den darüberliegenden Geschossen werden insgesamt 84 Studentenwohnungen, 28 Seniorenwohnungen sowie 2 hochwertige Penthouse-Apartments realisiert.Besonderes Augenmerk lag auf der Entwicklung effizienter Grundrisse, einer barrierearmen Erschließung sowie der Schaffung eines großzügig begrünten Innenhofs als gemeinschaftlicher Aufenthaltsbereich. Die Kombination aus urbaner Dichte, moderner Fassadensprache und funktionaler Freiraumgestaltung verleiht dem Quartier eine eigenständige architektonische Identität.Unser Büro begleitet das Bauvorhaben in sämtlichen Leistungsphasen – von der ersten Konzeptentwicklung über die Genehmigungs- und Ausführungsplanung bis hin zur späteren Realisierung. Ergänzend wurden umfangreiche Innen- und Außenvisualisierungen erstellt, um das Quartier bereits in der Planungsphase realitätsnah darzustellen. Die geplante Bauzeit beträgt voraussichtlich rund vier Jahre.",
},
{
  ...
  about:
    "Bei BIZZLIVING handelt es sich um die umfassende Sanierung und Modernisierung eines bestehenden Wohngebäudes mit insgesamt 54 Wohneinheiten in Baumholder. Ziel des Projekts ist die nachhaltige Aufwertung des Bestandsgebäudes unter Erhalt der vorhandenen Gebäudestruktur. Im Fokus stehen moderne Wohnkonzepte, eine energetische Optimierung sowie die Schaffung einer hochwertigen Wohnatmosphäre mit zeitgemäßer Architektur und funktionalen Grundrissen. Ein besonderes Merkmal des Projekts ist die Neugestaltung des großzügigen Innenhofs, der als zentraler Aufenthalts- und Begegnungsbereich für die Bewohner dient. Durch die Kombination aus Begrünung, Aufenthaltsflächen und moderner Außenraumgestaltung entsteht ein gemeinschaftsförderndes Wohnumfeld mit hoher Aufenthaltsqualität. Unser Büro begleitet das Bauvorhaben in den Leistungsphasen 1–4 – von der Bestandsaufnahme und Grundlagenermittlung über die Entwurfs- und Genehmigungsplanung bis hin zur Bauantragstellung. Ergänzend dazu wurden umfangreiche Innen- und Außenvisualisierungen erstellt, um die zukünftige Gestaltung des Projekts realitätsnah darzustellen. Besonderes Augenmerk lag auf der Verbindung aus wirtschaftlicher Bestandssanierung und moderner architektonischer Gestaltung. Durch gezielte Eingriffe in Fassade, Außenanlagen und Wohnbereiche wird das Gebäude nachhaltig modernisiert und langfristig aufgewertet. Der Baubeginn erfolgte im Februar 2025, die Fertigstellung ist für Mai 2026 vorgesehen."
},
];
